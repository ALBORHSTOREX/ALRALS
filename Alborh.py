...
os.system('xdg-open https://www.facebook.com/profile.php?id=100063762877802')

os.system('https://www.facebook.com/profile.php?id=100063762877802')
...
Show banner fullscreen    

  AUTHOR   :   AL RALS HACKER

  FACEBOOK :   AL RALS-ZAMZAM

  GITHUB    :   LB AL RALS

  LIFE STATUS  :  OSAMA-1982

  FB GROUP  : AL RALS HACKER 0004
